...
This component provides a unified interface for RCC integrations using ECPDF-Perl toolkit.
...
To get reporting one need to create a subclass of ECPDF::Component::EF::Reporing within your project and implement following functions:
...
For list of available methods of metadata object refer to: L<ECPDF::Component::EF::Reporting::Metadata>.
...
%%%LANG=perl%%%
    ...
    my $reporting = ECPDF::ComponentManager->loadComponent('EC::Plugin::YourPlugin::Reporting', {
...
sub prepareAndValidatePayloads {
    ...
    if (ref $payloadSet ne 'ECPDF::Component::EF::Reporting::Payloadset') {
        bailOut("PayloadSet are expected to be an ECPDF::Component::EF::Reporting::Payloadset reference. Got: " . ref $payloadSet);
    }
...
sub prepareAndValidateSinglePayload {
    ...
    if (!ref $payload) {
        bailOut("prepareAndValidateSinglePayload: Expected a ECPDF::Component::EF::Reporting::Payload reference for payload parameter.");
    }
    if (!ref $payload || ref $payload ne 'ECPDF::Component::EF::Reporting::Payload') {
        bailOut("prepareAndValidateSinglePayload: Expected ECPDF::Component::EF::Reporting::Payload, got:" . ref $payload);
    }
...
Creates a new L<ECPDF::Component::EF::Reporting::Dataset> object from records set.
...
=item (Optional)(ARRAY ref or records) A list of L<ECPDF::Component::EF::Reporting::Data> objects.
...
=item L<ECPDF::Component::EF::Reporting::Dataset>
...
Creates a new L<ECPDF::Component::EF::Reporting::Payloadset> object from records set.
...
=item L<ECPDF::Component::EF::Reporting::Payloadset>
